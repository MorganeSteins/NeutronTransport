...
particules dans l'intervalle $I_i = [x_i,x_{i+1}]$, de probab

\begin{equation*}
	p_{i|\mu_0} = \int_{I_i} \frac{\psi(x,\mu_0)}{\int_0^1 \psi(y,\mu_0)dy}dx = 
	\int_{I_i} \Sigma_S \psi(x,\mu_0)dx 
\end{equation*}
Or le nombre de particule dans l'intervale suit une loi binomiale à $N_x$
répétitions et de probabilité $p_i$. Ainsi, l'esp
...
\begin{equation}
	\frac{-1}{3} \ppt_0(x)'' = 1
\end{equation}
soit $\ppt_0(x)$ un polynôme d'ordre 2 en $x$ de la forme $\ppt_0(x) = -\frac{3}{2}x^2+bx+c$. Pour déterminer les coefficients on utilise la symétrie de la solution par rapport à la droite $x=\frac{1}{2}$ qui donne $b=3$. L'ordonnée à l'origine est donnée par les conditions aux limites de flux entrant nul.
