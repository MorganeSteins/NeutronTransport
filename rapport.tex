...
Par translation on obtient la solution de l'équation pour une source ponctuelle en $x_0$ 
\begin{equation}
    \label{eq:sol.point.x0}
    \pp_{x_0}(x,\mu) = \frac{1}{\mu} e^{-\frac{\st |x-x_0|}{\mu}}
\end{equation}
...
Dans notre démarche Monte-Carlo nous tirons maintenant $x_0$ le poiint de départ selon la loi de probabilité induite par la source. 
