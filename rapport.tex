...
\begin{equation*}
    f_{\mu_0}(x_1) = \int_0^1 f_{\mu_0}(x_1|x_0)f_{\psi,\mu_0}(x_0)\ dx_0
\end{equation*}
...
$$ f_{\mu_0}(x_1) = \st \int_0^1 \psi_{x_0}(x,\mu) \ dx  = \st \pp(x,\mu)$$
...
\begin{equation}
    \label{eq:diffusion}
    \left\{ \begin{aligned}
        \mu \frac{\partial \pp^0}{\partial x} (x,\mu) + \st \pp^0(x,\mu) &= \sa S(x,\mu)  \\
        \mu \frac{\partial \pp^n}{\partial x} (x,\mu) + \st \pp^n(x,\mu) &= \sa S(x,\mu) + \frac{\Ssss}{2} \into \pp^{n-1}(x,\mu')\ d\mu' \hspace{1cm} \forall n \geqslant 1
    \end{aligned}
    \right.
\end{equation}
...
\begin{align*}
    \tilde{f_{x}}(x_2) &= f(0\rightarrow 1)\into f_{\mu}(\mu_1) \int_{-1}^1 f_x(x_2|x_1,\mu_1)\tilde{f_x}(x_1)\  dx_1 d\mu_1 \\
    &=\frac{\Ssss}{\st}\into \frac{1}{2} \int_{-1}^1 \frac{\st}{2}\ppt^0(x_1)
\end{align*}
